...
try {
    ...
    $mensagem_erro = "Erro ao carregar lista de usuários.";
...
// Processa formulário
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['adicionar_vestido'])) {
    ...
    if (empty($nome) || empty($descricao) || empty($valoraluguel) || empty($tamanho) || empty($cedono)) {
        ...
        try {
            ...
            // Inseri vestido
            $sql = "INSERT INTO public.vestidos (nome, descricao, valoraluguel, tamanho, disponivel, cedono) 
                    VALUES (:nome, :descricao, :valoraluguel, :tamanho, :disponivel, :cedono)
                    RETURNING cpvestido";
            ...
            $mensagem_sucesso = "Vestido adicionado com sucesso!";
            ...
            $conn->rollBack();
            $mensagem_erro = "Erro ao adicionar vestido: " . $e->getMessage();
            error_log("Erro ao adicionar vestido: " . $e->getMessage());
        } finally {
            $conn = null;
        }
    }
...
<head>
    ...
    <title>Adicionar Vestido - MeuVestido.com</title>
    ...
    <div class="admin-container">
        ...
        <div class="main-content">
            ...
            <div class="form-container">
                <form method="post" action="vestido_adicionar.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="imagens">Imagens do Vestido</label>
                        <input type="file" id="imagens" name="imagens[]" accept="image/*" multiple onchange="previewImages(this)">
                        <p style="font-size: 0.9em; color: #666; margin-top: 5px;">Você pode selecionar múltiplas imagens. A primeira imagem será usada como imagem principal.</p>
                        <div class="image-preview" id="imagePreview"></div>
                    </div>
                    
                    <div class="form-actions">
                        <a href="vestidos.php" class="btn btn-danger">Cancelar</a>
                        <button type="submit" name="adicionar_vestido" class="btn btn-success">Adicionar Vestido</button>
                    </div>
                </form>
            </div>
        </div>
